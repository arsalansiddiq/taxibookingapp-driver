...
import com.taxibooking.user.FCM.ForceUpdateChecker;
import com.taxibooking.user.Fragments.Coupon;
import com.taxibooking.user.Fragments.Help;
import com.taxibooking.user.Fragments.HomeFragment;
import com.taxibooking.user.Fragments.Payment;
import com.taxibooking.user.Fragments.Wallet;
import com.taxibooking.user.Fragments.YourTrips;
import com.taxibooking.user.Helper.CustomDialog;
import com.taxibooking.user.Helper.LocaleUtils;
import com.taxibooking.user.Helper.SharedHelper;
import com.taxibooking.user.Helper.URLHelper;
import com.taxibooking.user.R;
import com.taxibooking.user.Retrofit.ResponseListener;
import com.taxibooking.user.Utils.CustomTypefaceSpan;
...
//                        .setAction("Action", null).show();
    ...
    private Fragment getHomeFragment() {
        ...
        switch (navItemIndex) {
            ...
            case 1:
                // Payment fragment
                com.taxibooking.user.Fragments.Payment paymentFragment = new Payment();
