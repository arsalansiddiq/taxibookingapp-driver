package com.taxibooking.driver;
...
import com.taxibooking.driver.Utilities.FontsOverride;
...
public class RightTransportDriverApplication extends Application {

    public static final String TAG = RightTransportDriverApplication.class
            .getSimpleName();

    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;

    private static RightTransportDriverApplication mInstance;
...
//        FontsOverride.setDefaultFont(this, "SANS_SERIF", "ClanPro-Book.otf");
    ...
    public static synchronized RightTransportDriverApplication getInstance() {
        return mInstance;
    }
